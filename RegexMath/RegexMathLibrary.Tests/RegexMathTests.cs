...
public class RegexMathTests
{
    ...
    public void Exponent_ShouldCalculate(string input, double expected) => RegexMath.Evaluate(input).ShouldBe(expected);
    ...
    public void Subtract_ShouldCalculate(string input, double expected) => RegexMath.Evaluate(input).ShouldBe(expected);
